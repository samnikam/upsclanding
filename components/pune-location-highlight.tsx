              ...
              <div className="space-y-3 mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm md:text-base text-gray-700">
                    <strong>English Medium Batch:</strong> 4:00 PM - 6:00 PM | <strong>Marathi Medium Batch:</strong> 6:00 PM - 8:00 PM
                  </span>
                </div>
                <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm md:text-base text-gray-700">
                    <strong>Location:</strong> Near Jnana Prabodhini, Sadashiv Peth, Pune
                  </span>
                </div>
              </div>
              ...
              <div className="text-center text-white">
                ...
                <div className="bg-white/10 rounded-lg p-3">
                  <p className="text-sm md:text-base font-medium">
                    📍 UPSC GUIDE, Near Jnana Prabodhini, Sadashiv Peth, Pune
                  </p>
                </div>
              </div>
            </div>
